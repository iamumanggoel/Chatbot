...
class MySpider(scrapy.Spider):
    name = 'spider'
    start_urls = ['https://kokofaceyoga.com/']
    ...
    def parse(self, response):
        ...
        with open('/home/cybertron/Documents/proj/kfychatbot/kokofaceyogachatbot/website_data/main_site_data.txt', 'a', encoding='utf-8') as f:
        ...
        for link in soup.find_all('a'):
            ...
            if href is not None:
                ...
                if parsed_url.netloc == '':
                    ...
                    absolute_url = urljoin("https://kokofaceyoga.com/", href)
